...
export const FEATURES: FeatureMeta[] = [
  ...
  { key: "gammaAbs", label: "Gamma power (30–45 Hz)", unit: "µV²", group: "frequency", description: "Absolute band power (requires fs > 112 Hz)." },
  { key: "deltaRel", label: "Relative delta power", unit: "ratio", group: "frequency", description: "Delta power / total analysed-band power." },
  ...
  { key: "totalPower", label: "Total spectral power", unit: "µV²", group: "frequency", description: "Integrated PSD across the analysed band (0.5–45 Hz)." },
...
export function extractFeatures(x: Float64Array, fs: number, fMaxHz?: number): ExtractionResult {
  ...
  const features: FeatureVector = {
    ...
    totalPower: total,
    dominantFreq: dominantFrequency(sp, 0.5, ceiling),
